...
namespace voxelization {
    ...
    public:
        ...
        virtual void setResolution(int x, int y, int z) = 0;
        virtual void setBoundingBox(double min_x, double min_y, double min_z, double max_x, double max_y, double max_z) = 0;
        virtual bool voxelize(const std::vector<std::shared_ptr<SpatialEntity>>& entities) = 0;
        virtual bool saveVoxelGrid(const std::string& filename) const = 0;
    };
